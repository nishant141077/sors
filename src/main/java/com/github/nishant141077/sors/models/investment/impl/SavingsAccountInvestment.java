...
public class SavingsAccountInvestment extends Investment {
  ...
  @Builder
  public SavingsAccountInvestment(String name, String investmentId, InvestmentState state,
      String bankName, String lastFourDigits, double interestRate, String accountHolder,
      Date createdAt, Date updatedAt) {
    super(InvestmentType.SAVINGS_ACCOUNT, name, investmentId, state, createdAt, updatedAt);
